"""
miller_drift_detector.py - Project script.
...
Paths (relative to repo root)
    ...
    OUTPUT FILE: artifacts/drift_summary_miller.csv

Terminal command to run this file from the root project folder

    uv run python -m cintel.miller_drift_detector
"""
...
OUTPUT_FILE: Final[Path] = ARTIFACTS_DIR / "drift_summary_miller.csv"
SUMMARY_LONG_FILE: Final[Path] = ARTIFACTS_DIR / "drift_summary_long_miller.csv"
...
REQUESTS_STD_DRIFT_THRESHOLD: Final[float] = 3.0
ERRORS_STD_DRIFT_THRESHOLD: Final[float] = 1.0
LATENCY_STD_DRIFT_THRESHOLD: Final[float] = 200.0
...
def main() -> None:
    ...
    # ----------------------------------------------------
    # STEP 4.1: DEFINE PERCENT CHANGE RECIPES
    # ----------------------------------------------------
    # A percent change recipe calculates:
    #
    #     (current average - reference average) / reference average * 100
    #
    ...
    # ----------------------------------------------------
    # STEP 4.2: APPLY THE RECIPES TO EXPAND THE DATAFRAME
    # ----------------------------------------------------
